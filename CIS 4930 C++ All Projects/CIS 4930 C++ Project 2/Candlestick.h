...
public:
	...
	Candlestick();
	//default Candlestick constructor sets date to current date, and also sets the rest of the variables to 0
	Candlestick(String^);
	...
	//Constructor will take as arguments all of the properties and initialize the variables automatically
};